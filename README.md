...
- FIFO lots and immutable cash-ledger events provide the accounting foundation. Simulated cash dividends and splits are scheduled in-app and processed idempotently across affected portfolios.
...
- P&L, current positions, and the immutable cash ledger can be exported as local CSV files.
